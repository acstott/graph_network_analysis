...
e.) Make a matrix of eigenvalues determined in d and create a tree from this data using the igraph make_tree funciton – The multiplicity of the eigenvalues are equal to the number of connected components
